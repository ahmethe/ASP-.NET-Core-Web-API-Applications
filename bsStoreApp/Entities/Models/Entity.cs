...
/* 
<summary>
    Çalışma zamanında bu sınıf kullanılacak. Genel bir varlık tanımı olacak.
    Çalışma zamanında kullanılacak bir sınıf olması sebebiyle DynamicObject kalıtım alındı, XML serileştirme işlemi için
    IXmlSerializable, XML çıktı oluştururken kullanacağımız key-value çiftleri için ise IDictionary<string, object>
    implemente edildi.
</summary>
*/
